    ...
    private async Task<bool> DispatchAsync(string tag, string command, string arguments)
    {
        ...
        switch (command)
        {
            ...
            case "CREATE":
                ...
                await RunScopedAsync(scope => ImapMailboxLifecycle.CreateAsync(this, scope, tag, arguments));
                return true;
            case "DELETE":
                ...
                await RunScopedAsync(scope => ImapMailboxLifecycle.DeleteMailboxAsync(this, scope, tag, arguments));
                return true;
            case "RENAME":
                await RunScopedAsync(scope => ImapMailboxLifecycle.RenameMailboxAsync(this, scope, tag, arguments));
                return true;
