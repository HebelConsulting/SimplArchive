...
/// <summary>
/// What things in an inbox are called, and how a new name is found when the obvious one is taken.
/// </summary>
/// <remarks>
/// One place rather than two, because the inbox now has <b>two</b> callers doing the same naming: the ingest
...
/// </remarks>
public static class InboxNaming
{
