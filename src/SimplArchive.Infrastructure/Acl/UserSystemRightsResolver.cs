    ...
    public async Task<SystemRightsSet> GetEffectiveSystemRightsAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        var own = await _dbContext.Users
            ...
            .Select(u => new SystemRightsSet(
                ...
                u.CanManageIntrays, u.CanCreateExternalLink, u.CanAccessWithoutGrant, u.CanManageMailRouting,
                u.CanBlockResources, u.CanReleaseResources))
        ...
        var groupRights = await _dbContext.Groups
            ...
            .Select(g => new SystemRightsSet(
                ...
                g.CanManageIntrays, g.CanCreateExternalLink, g.CanAccessWithoutGrant, g.CanManageMailRouting,
                g.CanBlockResources, g.CanReleaseResources))
