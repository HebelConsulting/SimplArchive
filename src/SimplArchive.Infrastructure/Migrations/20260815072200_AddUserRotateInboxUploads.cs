...
{
    /// <inheritdoc />
    public partial class AddUserRotateInboxUploads : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //
            // This setting is SPLIT OUT of DeskewInboxUploads rather than replacing it: the two corrections
