...
{
    /// <inheritdoc />
    public partial class AddUserCutIntrayUploadsAtPatchCodes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //
            // The sibling migration AddUserDeskewIntrayUploads says the rest, and it applies here unchanged: the
            ...
            migrationBuilder.AddColumn<bool>(
                name: "CutIntrayUploadsAtPatchCodes",
                table: "Users",
                type: "boolean",
                nullable: false,
                defaultValue: true);
