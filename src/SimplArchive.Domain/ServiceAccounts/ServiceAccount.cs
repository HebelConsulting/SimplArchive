...
public class ServiceAccount : ITenantScoped, IConcurrencyTracked
{
    ...
    /// <summary>
    /// The ETag/If-Match optimistic-concurrency token (#1083). Regenerated by SaveChanges on every
    /// Added/Modified instance — never set it by hand.
    /// </summary>
