...
public sealed class PrincipalRowViewModel(bool isGroup, Guid id, string name, bool isActive, AdminClient.SystemRightsData rights, bool mfaEnabled = false,
    AdminClient.PrincipalInfo? source = null)
{
    ...
    public AdminClient.PrincipalInfo? Source { get; } = source;
    ...
    public AdminClient.SystemRightsData Rights { get; set; } = rights;
