...
public sealed class LegalHoldRowViewModel(Guid id, string name, bool isActive, int itemCount, SimplArchive.DesktopClient.Services.LegalHoldsClient.LegalHoldInfo hold)
{
    public SimplArchive.DesktopClient.Services.LegalHoldsClient.LegalHoldInfo Hold { get; } = hold;
...
public sealed class LegalHoldItemRowViewModel(Guid documentId, string documentName, SimplArchive.DesktopClient.Services.LegalHoldsClient.LegalHoldItemInfo item)
{
    public SimplArchive.DesktopClient.Services.LegalHoldsClient.LegalHoldItemInfo Item { get; } = item;
