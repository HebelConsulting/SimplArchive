...
// InboxPageOperationsTests' job — this proves the affordance and the immediate feedback.
[Collection(UiCollection.Name)]
[Trait("Area", "ui-2")]
public class WebInboxSortRotationTests
{
    private readonly SelfHostedAppFixture _app;

    public WebInboxSortRotationTests(SelfHostedAppFixture app) => _app = app;
